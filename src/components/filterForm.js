      ...
      <form action="#" autocomplete="off">
        <div className="row">
            <div className="col-xl-4 col-md-6 mb-4">
              <label for="form_dates" className="form-label">Dates</label>
            ...
            <div className="col-xl-4 col-md-6 mb-4">
              <label for="form_guests" className="form-label">Location</label>
              ...
              <button type="button" className="btn dropdown-toggle bs-placeholder btn-selectpicker" data-toggle="dropdown" role="button" data-id="form_guests" title="">
            ...
            <div className="col-xl-4 col-md-6 mb-4">
              <label for="form_type" className="form-label">Category</label>
              ...
              <button type="button" className="btn dropdown-toggle bs-placeholder btn-selectpicker" data-toggle="dropdown" role="button" data-id="form_type" title=""><div className="filter-option"><div className="filter-option-inner"><div className="filter-option-inner-inner"></div></div> </div></button><div className="dropdown-menu " role="combobox"><div className="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul className="dropdown-menu inner show"></ul></div></div></div>
            </div>
            <div className="col-xl-4 col-md-6 mb-4">
            // price range
            </div>
